    ...
    while True:
        ...
        for i in world:
            if i == 19 or i == 25 or i == 26:
                continue
            wumpus = random.randint(1, 110)
            pit = random.randint(1, 110)
...
def goforward(r, c, i):
    ...
    if not bump(i):
        ...
        if existObj[index][0] == True:
            ...
            wumpusObj[index].shape("./baseCode/data/wumpus.gif")
            wumpusObj[index].showturtle()
        elif existObj[index][1] == True:
            obj.goto(i, j)
            obj.shape("./baseCode/data/pit.gif")
            obj.stamp()
        elif existObj[index][2] == True:
            obj.goto(i, j)
            obj.shape("./baseCode/data/gold.gif")
            obj.showturtle()
...
def setAgent():
    ...
    if head == 0:
        ...
        agent.shape("./baseCode/data/traveler90.gif")
    elif head == 180:
        agent.shape("./baseCode/data/traveler180.gif")
    elif head == 270:
        agent.shape("./baseCode/data/traveler270.gif")
...
def shoot(r, c, i):
    global arrowNum
    arrowNum -= 1
    screen.bgpic("./baseCode/data/world" + str(arrowNum) + ".gif")
    p = c * 100 - 250
    q = r * (-100) + 250
    x, y = agent.position()
    if x < p:
        arrow.shape("./baseCode/data/arrow0.gif")
    elif y < q:
        arrow.shape("./baseCode/data/arrow90.gif")
    elif x > p:
        arrow.shape("./baseCode/data/arrow180.gif")
    elif y > q:
        arrow.shape("./baseCode/data/arrow270.gif")
    arrow.goto(x, y)
    arrow.showturtle()
    arrow.goto(p, q)
    arrow.hideturtle()
...
def climb():
    agent.shape("./baseCode/data/climber.gif")
    agent.goto(-250, 500)
    screen.exitonclick()
...
screen.bgpic("./baseCode/data/world2.gif")
screen.addshape("./baseCode/data/traveler0.gif")
screen.addshape("./baseCode/data/traveler90.gif")
screen.addshape("./baseCode/data/traveler180.gif")
screen.addshape("./baseCode/data/traveler270.gif")
screen.addshape("./baseCode/data/climber.gif")
screen.addshape("./baseCode/data/wumpus.gif")
screen.addshape("./baseCode/data/pit.gif")
screen.addshape("./baseCode/data/gold.gif")
screen.addshape("./baseCode/data/arrow0.gif")
screen.addshape("./baseCode/data/arrow90.gif")
screen.addshape("./baseCode/data/arrow180.gif")
screen.addshape("./baseCode/data/arrow270.gif")
